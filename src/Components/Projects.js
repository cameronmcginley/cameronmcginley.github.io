...
const projects = [
  {
    ...
    alt: "Dashboard interface of the Course Sign-In App",
    tools: [
      {
        text: "JavaScript",
  ...
  },
  {
    ...
    project_link: "",
    gh_link: "https://github.com/cameronmcginley/optimized-brainfk-interpreter",
    description:
    ...
    alt: "Visual representation of the Brainf**k Interpreter project",
    tools: [
      {
        text: "C++",
  ...
  },
  {
    ...
    alt: "Interface of Projectile Points Database web application with search features",
    tools: [
      {
        text: "TypeScript",
  ...
  },
  {
    ...
    alt: "Visualization of sorting algorithms in action within the Sorting Visualizer app",
    tools: [
      {
        text: "JavaScript",
        link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript",
  ...
  },
  {
    ...
    alt: "Graphical output and metrics from the Machine Learning Algorithm Tester",
    tools: [
      {
        text: "Python",
  ...
  },
  {
    ...
    alt: "Preview of Roblox Object Placement System showing in-game object manipulation",
    tools: [
      {
        text: "Lua",
  ...
  return (
    <div name="Projects" className="section publications">
      ...
      {projects.map((project, index) => (
        <ProjectCard cardData={project} key={index} />
      ))}
    </div>
  );
};
