    ...
    <div name="Projects" className="section publications">
      ...
      <ProjectCard
        cardData={{
          ...
          image: "project-sortingvisualizer-gif.webp",
          tools: [
            {
              text: "Javascript",
              link: "https://developer.mozilla.org/en-US/docs/Web/JavaScript",
      ...
      <ProjectCard
        cardData={{
          ...
          image: "project-rblxplacement-gif.webp",
          tools: [
            {
              text: "Lua",
      ...
      <ProjectCard
        cardData={{
          ...
          image: "project-personalwebsite-image.webp",
          is_last: true,
          tools: [
            {
              text: "Javascript",
      ...
      {/* <ProjectCard
        cardData={{
          ...
          image: "project-movierecommender-image2.webp",
          tools: [
            {
              text: "Python",
              link: "https://www.python.org/",
