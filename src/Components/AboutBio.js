    ...
    <div className="about bio">
        ...
        <div className="about bio lists">
            <AboutList title="Education" items={[
                {text: "M.S. in Computer Science", secondary: "University of California, San Diego (expected 2023)"},
                {text: "B.S. in Computer Science", secondary: "Wichita State University (2022)"}
            ]}/>
